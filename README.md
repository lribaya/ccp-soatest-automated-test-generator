...
```powershell
python "test_generator_ccp.py" --CSV_FILE_PATH "C:\SOATest_CCP_Template.csv" --GENERATED_TST_PATH "C:\path_to_workspace\TestAssets\CCPPlan_generated.tst"
```

3. To log all API calls, add `--DEBUG`:

```powershell
python "test_generator_ccp.py" --CSV_FILE_PATH "C:\SOATest_CCP_Template.csv" --GENERATED_TST_PATH "C:\path_to_workspace\TestAssets\CCPPlan_generated.tst" --DEBUG
```
